...
import { X, Droplets, Flame, Plus, RefreshCw } from 'lucide-react';
      ...
      <div className="flex flex-col gap-8">
          ...
          <div className="bg-white dark:bg-charcoal rounded-3xl p-6 shadow-xl border border-gray-100 dark:border-white/5 relative overflow-hidden transition-colors duration-300">
              ...
              <div className="h-4 bg-gray-100 dark:bg-surface rounded-full overflow-hidden mb-6 relative z-10">
                  <div className="h-full bg-cyan-500 dark:bg-[#00E5FF] rounded-full transition-all duration-700" style={{ width: `${waterPercent}%` }}></div>
              </div>
          ...
          <div className="bg-white dark:bg-charcoal rounded-3xl p-6 shadow-xl border border-gray-100 dark:border-white/5 relative overflow-hidden transition-colors duration-300">
              <div className="flex justify-between items-start mb-6 relative z-10">
               ...
               {/* Progress Bar */}
               <div className="h-4 bg-gray-100 dark:bg-surface rounded-full overflow-hidden mb-6 relative z-10">
                  <div className={`h-full rounded-full transition-all duration-700 ${calPercent > 100 ? 'bg-red-500' : 'bg-orange-500'}`} style={{ width: `${Math.min(calPercent, 100)}%` }}></div>
              </div>
