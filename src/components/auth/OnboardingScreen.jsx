...
export default function OnboardingScreen({ onContinue, isDark, onToggleTheme }) {
  ...
  return (
    <div className="hc-auth-safe-screen relative flex min-h-[100dvh] flex-col overflow-hidden bg-[#F5F7FB] px-6 pb-[calc(env(safe-area-inset-bottom)+1.75rem)] pt-8 text-gray-900 dark:bg-[#0A0D14] dark:text-white">
