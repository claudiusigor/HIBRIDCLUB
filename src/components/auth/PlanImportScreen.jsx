    ...
    <div className="relative min-h-[100dvh] overflow-hidden bg-[#F5F7FB] px-6 pb-10 pt-8 text-gray-900 dark:bg-[#0A0D14] dark:text-white">
      ...
      <div className="relative mx-auto flex min-h-[calc(100dvh-4rem)] w-full max-w-sm flex-col">
        ...
        <div className="mt-7 text-center">
          ...
          <p className="mx-auto mt-3 max-w-[18rem] text-[14px] leading-relaxed text-gray-500 dark:text-gray-400">
            O arquivo deve conter sessões A-F com exercícios e séries/alvos para força e cardio.
          </p>
        </div>

        <div className="mt-7 rounded-[30px] border border-black/[0.05] bg-white/84 p-5 shadow-[0_20px_44px_rgba(15,23,42,0.08)] backdrop-blur-2xl dark:border-white/[0.08] dark:bg-white/[0.05] dark:shadow-[0_20px_44px_rgba(0,0,0,0.3)]">
          ...
          {fileName && <p className="mt-3 text-center text-[12px] text-gray-500 dark:text-gray-400">Arquivo: {fileName}</p>}

          {parsedPlan && (
            <div className="mt-4 rounded-[22px] border border-black/[0.05] bg-[#F7F9FD] p-4 dark:border-white/[0.08] dark:bg-white/[0.04]">
